...
<div class="col-md-2"></div>
      ...
      <div class="col-md-8">
          ...
          <div class="box-header with-border">
            <h3 class="box-title"><strong>Add New Supplier</strong></h3>
          </div>
          <div class="box-body">
          ...
          <div class="box-body">
          	...
          	@include('partials.message')
				 ...
				 <form class="form-horizontal" action="{{ route('crm.supplier.store') }}" method="post">

				 	@csrf
						    <div class="form-group">
						      <label class="control-label col-sm-4" for="company_name">Supplier Name</label>
						      <div class="col-sm-8">
						        <input type="text" class="form-control" name="supplier_name" id="supplier_name" placeholder="Enter company name" 
						        >
						      </div>
						    </div>
						    ...
						    <div class="form-group">
						      ...
						      <div class="col-sm-8">
						        <input type="number" class="form-control" name="phone_no2" id="phone_no2" placeholder="Enter Phone No (Optional)" 
						        >
						      </div>
						    </div>
